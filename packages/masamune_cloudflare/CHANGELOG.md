...
- Add conditional exports for Workers and prevent Express Response types from being imported at runtime. Preserve existing exports from the Node entry point.
- Add shared vector value validation, Vectorize binding resolution, namespaces, and exponential backoff behavior for D1, DO, and KV.
