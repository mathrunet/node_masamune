...
import { D1WorkersOptions } from "./types";
 ...
 */
export const defaultD1ServerAccessHeader = "x-masamune-server-token";
 ...
 */
export function isD1ServerRequest(
  context: Context,
  options: Pick<D1WorkersOptions, "serverAccessToken" | "serverAccessHeader">,
): boolean {
