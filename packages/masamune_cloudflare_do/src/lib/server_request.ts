...
import { DurableObjectWorkersOptions } from "./types";
 ...
 */
export const defaultDoServerAccessHeader = "x-masamune-server-token";
 ...
 */
export function isDoServerRequest(
  context: Context,
  options: Pick<DurableObjectWorkersOptions, "serverAccessToken" | "serverAccessHeader">,
): boolean {
