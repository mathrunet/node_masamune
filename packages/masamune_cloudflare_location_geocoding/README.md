<p align="center">
  ...
  <h1 align="center">Masamune Location Geocoding for Cloudflare Workers</h1>
</p>
...
```bash
npm install @mathrunet/masamune_cloudflare_location_geocoding
```
...
```typescript
import * as m from "@mathrunet/masamune_cloudflare_location_geocoding";
