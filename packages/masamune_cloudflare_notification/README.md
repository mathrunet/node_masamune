<p align="center">
  ...
  <h1 align="center">Masamune Notification for Cloudflare Workers</h1>
</p>
...
```bash
npm install @mathrunet/masamune_cloudflare_notification
```
...
```typescript
import * as m from "@mathrunet/masamune_cloudflare_notification";
