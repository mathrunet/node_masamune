<p align="center">
  ...
  <h1 align="center">Masamune Purchase for Cloudflare Workers</h1>
</p>
...
```bash
npm install @mathrunet/masamune_cloudflare_purchase
```
...
```typescript
import * as m from "@mathrunet/masamune_cloudflare_purchase";
