...
- Add fixed-dimension vector validation, storage, nearest-neighbor search, and per-document authorization. Verify migrations, CRUD, and rollback against a real TiDB instance.

- Switch TiDB to direct HTTPS connections and remove the Data Service compatibility path. Add a shared schema, administrative migrations, serialized transactions, and a Worker entry point. See MIGRATION.md for breaking-change migration instructions.
