<p align="center">
  ...
  <h1 align="center">Masamune Token Android for Cloudflare Workers</h1>
</p>
...
```bash
npm install @mathrunet/masamune_cloudflare_token_android
```
...
```typescript
import * as m from "@mathrunet/masamune_cloudflare_token_android";
...
m.deploy(
    exports,
    [
        // Function for Android token.
        m.Functions.androidToken,
    ],
);
```
