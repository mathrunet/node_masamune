<p align="center">
  ...
  <h1 align="center">Masamune Token Google for Cloudflare Workers</h1>
</p>
...
```bash
npm install @mathrunet/masamune_cloudflare_token_google
```
...
```typescript
import * as m from "@mathrunet/masamune_cloudflare_token_google";
...
m.deploy(
    exports,
    [
        // Function for Google token.
        m.Functions.googleToken,
    ],
);
```
