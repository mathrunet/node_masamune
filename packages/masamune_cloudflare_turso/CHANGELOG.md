...
- Add native vector CRUD and exact nearest-neighbor search using TursoDB F32_BLOB.

- Add automatic database placement across groups based on location, a placement resolver, and group membership validation.
- Isolate database connection caches by organization and credentials, and handle concurrent creation races.
