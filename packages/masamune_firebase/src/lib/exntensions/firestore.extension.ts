...
import { FirestoreModelFieldValueConverterUtils } from "../model_field_value/default_model_field_value_converter";
import { VectorValue } from "@google-cloud/firestore";
import { ModelRefFirebase } from "../model_field_value/model_field_value";
import { ModelFieldValueConverterUtils, ModelGeoValue, ModelTimestamp, ModelVectorValue } from "@mathrunet/masamune";
...
declare module "firebase-admin/firestore" {
    interface DocumentReference<AppModelType, DbModelType extends firestore.DocumentData> {
        ...
        /**
         * Convert to ModelRefFirebase.
         * 
         * ModelRefFirebaseに変換します。
         * 
         * @returns {ModelRefFirebase}
         * ModelRefFirebase.
         * 
         * ModelRefFirebase。
         */
        toModelRefFirebase(): ModelRefFirebase;
    }
 ...
 * ModelRefBase。
 */
(firestore.DocumentReference.prototype as any).toModelRefFirebase = function <AppModelType extends { [field: string]: any }, DbModelType extends firestore.DocumentData>(
    this: firestore.DocumentReference<AppModelType, DbModelType>
): ModelRefFirebase {
    const path = this.path.replace(/\/+$/, "");
    return new ModelRefFirebase(path, this.firestore.doc(path));
};
