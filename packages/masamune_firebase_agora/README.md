<p align="center">
  ...
  <h1 align="center">Masamune Agora for Firebase Functions</h1>
</p>
...
```bash
npm install @mathrunet/masamune_firebase_agora
```
...
```dart
import * as m from "@mathrunet/masamune_firebase_agora";
