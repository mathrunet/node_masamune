<p align="center">
  ...
  <h1 align="center">Masamune AI OpenAI for Firebase Functions</h1>
</p>
...
```bash
npm install @mathrunet/masamune_firebase_ai_openai
```
...
```typescript
import * as m from "@mathrunet/masamune_firebase_ai_openai";
