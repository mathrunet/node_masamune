<p align="center">
  ...
  <h1 align="center">Masamune Algolia for Firebase Functions</h1>
</p>
...
Masamune framework plugin package for Algolia support.
...
```bash
npm install @mathrunet/masamune_firebase_algolia
```
...
```dart
import * as m from "@mathrunet/masamune_firebase_algolia";
