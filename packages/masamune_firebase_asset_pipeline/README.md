<p align="center">
  ...
  <h1 align="center">Masamune Asset Pipeline for Firebase Functions</h1>
</p>
...
```bash
npm install @mathrunet/masamune_firebase_asset_pipeline
```
...
```dart
import * as m from "@mathrunet/masamune_firebase_asset_pipeline";
