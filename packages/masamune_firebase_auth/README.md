<p align="center">
  ...
  <h1 align="center">Masamune Firebase Auth for Firebase Functions</h1>
</p>
...
```bash
npm install @mathrunet/masamune_firebase_auth
```
...
```typescript
import * as m from "@mathrunet/masamune_firebase_auth";
...
m.deploy(
    exports,
    [
        // Function for deleting a FirebaseAuthentication user.
