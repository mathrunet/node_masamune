<p align="center">
  ...
  <h1 align="center">Masamune Firebase Firestore for Firebase Functions</h1>
</p>
...
```bash
npm install @mathrunet/masamune_firebase_firestore
```
...
```typescript
import * as m from "@mathrunet/masamune_firebase_firestore";
...
m.deploy(
    ...
    [
        ...
        m.Functions.collectionModelFirestore,
    ],
);
```
