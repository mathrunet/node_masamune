<p align="center">
  ...
  <h1 align="center">Masamune Location Geocoding for Firebase Functions</h1>
</p>
...
```bash
npm install @mathrunet/masamune_firebase_location_geocoding
```
...
```typescript
import * as m from "@mathrunet/masamune_firebase_location_geocoding";
