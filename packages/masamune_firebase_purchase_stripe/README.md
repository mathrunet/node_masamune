<p align="center">
  ...
  <h1 align="center">Masamune Purchase Stripe for Firebase Functions</h1>
</p>
...
This is a Masamune framework plugin package that executes Stripe's backend validation and other related processes.
...
```bash
npm install @mathrunet/masamune_firebase_purchase_stripe
```
...
```dart
import * as m from "@mathrunet/masamune_firebase_purchase_stripe";
