<p align="center">
  ...
  <h1 align="center">Masamune Scheduer for Firebase Functions</h1>
</p>
...
```bash
npm install @mathrunet/masamune_firebase_scheduler
```
...
```dart
import * as m from "@mathrunet/masamune_firebase_scheduler";
