<p align="center">
  ...
  <h1 align="center">Masamune Storage for Firebase Functions</h1>
</p>
...
Cloud Storage for Firebase Masamune framework package plugin.
...
```bash
npm install @mathrunet/masamune_firebase_storage
```
...
```dart
import * as m from "@mathrunet/masamune_firebase_storage";
...
m.deploy(
    exports,
    [
        // Function for Agora.io token.
        m.Functions.agoraToken,
    ],
);
```
