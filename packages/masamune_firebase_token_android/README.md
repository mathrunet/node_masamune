<p align="center">
  ...
  <h1 align="center">Masamune Token Android for Firebase Functions</h1>
</p>
...
```bash
npm install @mathrunet/masamune_firebase_token_android
```
...
```typescript
import * as m from "@mathrunet/masamune_firebase_token_android";
