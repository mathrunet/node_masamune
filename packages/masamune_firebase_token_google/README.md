<p align="center">
  ...
  <h1 align="center">Masamune Token Google for Firebase Functions</h1>
</p>
...
```bash
npm install @mathrunet/masamune_firebase_token_google
```
...
```typescript
import * as m from "@mathrunet/masamune_firebase_token_google";
