<p align="center">
  ...
  <h1 align="center">Masamune Workflow for Firebase Functions</h1>
</p>
...
```bash
npm install @mathrunet/masamune_firebase_workflow
```
...
```typescript
import * as m from "@mathrunet/masamune_firebase_workflow";
...
m.deploy(
    exports,
    [
        // Function for scheduling workflow.
        m.Functions.workflowScheduler,
    ],
);
```
