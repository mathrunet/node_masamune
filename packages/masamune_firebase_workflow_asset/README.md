<p align="center">
  ...
  <h1 align="center">Masamune Workflow Asset for Firebase Functions</h1>
</p>
...
```bash
npm install @mathrunet/masamune_firebase_workflow_asset
```
...
```dart
import * as m from "@mathrunet/masamune_firebase_workflow_asset";
