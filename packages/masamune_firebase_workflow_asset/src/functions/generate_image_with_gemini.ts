/**
 * A function for generating images using Gemini 2.0 Flash Experimental.
...
import { Action, WorkflowProcessFunctionBase, WorkflowContext } from "@mathrunet/masamune_firebase_workflow";
