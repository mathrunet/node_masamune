<p align="center">
  ...
  <h1 align="center">Masamune Workflow Marketing for Firebase Functions</h1>
</p>
...
Masamune framework package plugin that manages marketing tools for Masamune Workflow.
...
```bash
npm install @mathrunet/masamune_firebase_workflow_marketing
```
...
```dart
import * as m from "@mathrunet/masamune_firebase_workflow_marketing";
...
m.deploy(
    exports,
    [
        // Function for google play console.
        m.Functions.collectFromGooglePlayConsole,
    ],
);
```
