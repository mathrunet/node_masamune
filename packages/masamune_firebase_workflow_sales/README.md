<p align="center">
  ...
  <h1 align="center">Masamune Workflow Sales for Firebase Functions</h1>
</p>
...
```bash
npm install @mathrunet/masamune_firebase_workflow_sales
```
...
```typescript
import * as m from "@mathrunet/masamune_firebase_workflow_sales";
...
m.deploy(
    exports,
    [
        // Function for sending sales email.
        m.Functions.sendSalesEmail,
    ],
);
```
