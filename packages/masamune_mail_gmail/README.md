<p align="center">
  ...
  <h1 align="center">Masamune Mail Gmail</h1>
</p>
...
Masamune framework package plugin for Gmail support.
...
```bash
npm install @mathrunet/masamune_mail_gmail
```
...
```dart
import * as m from "@mathrunet/masamune_mail_gmail";
