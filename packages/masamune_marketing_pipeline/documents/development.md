...
- [x] Google Play Developer API クライアント実装
  - [x] ダウンロード数、インストール数、アンインストール数
  - [x] ストア評価、レビュー
  - [x] 売上データ
- [x] Firebase Analytics Data API クライアント実装
  - [x] DAU/WAU/MAU
  - [x] 年齢層、性別、国、言語、端末
  - [x] セッション時間
- [x] GitHub API クライアント実装
  ...
  - [x] Issue/PR数
  - [x] 最新リリース
- [x] App Store Connect API クライアント実装
  - [x] ダウンロード数、売上
  - [x] 評価、レビュー
- [x] データ収集オーケストレーター関数の実装
