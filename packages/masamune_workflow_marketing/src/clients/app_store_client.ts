...
import {
    ...
    AppStoreGetReviewsOptions,
} from "../models";

// Re-export types for backward compatibility
export { DateRange, RatingDistribution, Review, AppStoreClientConfig };

// Local type aliases for backward compatibility
export type AppInfo = AppStoreAppInfo;
export type AppRatings = AppStoreRatings;
export { AppStoreReview, AppStoreReviewsResponse, AppStoreGetReviewsOptions };
