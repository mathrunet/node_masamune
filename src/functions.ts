...
export const Functions = {
   ...
   */
  geocoding: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "geocoding", func: require("./functions/geocoding"), options: options }),
  /** 
   * Function for sending PUSH notifications.
   * 
   * PUSH通知を送信するためのFunction。
   */
  sendNotification: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "send_notification", func: require("./functions/send_notification"), options: options }),
  /** 
   ...
   */
  openAIChatGPT: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "openai_chat_gpt", func: require("./functions/openai_chat_gpt"), options: options }),
  /** 
   * Obtain an Agora.io security token.
   * 
   * Agora.ioのセキュリティトークンを取得します。
   */
  agoraToken: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "agora_token", func: require("./functions/agora_token"), options: options }),
  /**
   ...
   */
  agoraCloudRecording: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "agora_cloud_recording", func: require("./functions/agora_cloud_recording"), options: options }),
  /**
   ...
   */
  stripe: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "stripe", func: require("./functions/stripe"), options: options }),
  /**
   ...
   * Firestoreとの連携が必須です。Firestoreも利用可能にしてください。
   */
  stripeWebhook: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "stripe_webhook", func: require("./functions/stripe_webhook"), options: options }),
  /**
   ...
   * Firestoreとの連携が必須です。Firestoreも利用可能にしてください。
   */
  stripeWebhookConnect: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "stripe_webhook_connect", func: require("./functions/stripe_webhook_connect"), options: options }),
  /**
   ...
   */
  stripeWebhookSecure: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "stripe_webhook_secure", func: require("./functions/stripe_webhook_secure"), options: options }),
  /**
   * Send email via Gmail.
   *
   * Gmailでメールを送信します。
   */
  gmail: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "gmail", func: require("./functions/gmail"), options: options }),
  /**
   * Send mail through SendGrid.
   *
   * SendGridでメールを送信します。
   */
  sendGrid: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "send_grid", func: require("./functions/send_grid"), options: options }),
  /**
   ...
   */
  androidAuthCode: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "android_auth_code", func: require("./functions/android_auth_code"), options: options }),
  /**
   * After being redirected from [android_auth_code], you will get a refresh token to connect to Google's API. Applications Library System Users Volumes bin cores dev etc home opt private sbin tmp usr var Execute [android_auth_code] after registering the required information.
   *
   * [android_auth_code]からリダイレクトされた後、GoogleのAPIに接続するためのリフレッシュトークンを取得します。
   * 必要情報を登録した後[android_auth_code]を実行してください。
   */
  androidToken: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "android_token", func: require("./functions/android_token"), options: options }),
  /**
   ...
   */
  consumableVerifyAndroid: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "consumable_verify_android", func: require("./functions/consumable_verify_android"), options: options }),
  /**
   * Performs a consumption-type in-app purchase. The value of the field in the document specified in [path] is added to [value].
   *
   * 消費型のアプリ内課金を行います。[path]に指定したドキュメント内のフィールドの値を[value]に加算します。
   */
  consumableVerifyIOS: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "consumable_verify_ios", func: require("./functions/consumable_verify_ios"), options: options }),
  /**
   ...
   */
  nonconsumableVerifyAndroid: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "nonconsumable_verify_android", func: require("./functions/nonconsumable_verify_android"), options: options }),
  /**
   * Performs non-consumable in-app purchases. Unlock by setting the value of the field in the document specified in [path] to `true`.
   *
   * 非消費型のアプリ内課金を行います。[path]に指定したドキュメント内のフィールドの値を`true`にすることでアンロックを行います。
   */
  nonconsumableVerifyIOS: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "nonconsumable_verify_ios", func: require("./functions/nonconsumable_verify_ios"), options: options }),
  /**
   ...
   */
  purchaseWebhookIOS: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "purchase_webhook_ios", func: require("./functions/purchase_webhook_ios"), options: options }),
  /**
   * Verify subscriptions and add data.
   *
   * サブスクリプションの検証とデータの追加を行います。
   */
  subscriptionVerifyAndroid: (options: data.FunctionsOptions = {}) => new data.FunctionsData({ id: "subscription_verify_android", func: require("./functions/subscription_verify_android"), options: options }),
  /**
   * Verify subscriptions and add data.
   *
   * サブスクリプションの検証とデータの追加を行います。
